...
cdef class Stack:
    ...
    cdef int push(self, SIZE_t start, SIZE_t end,  SIZE_t start_expo, SIZE_t end_expo, #HERE
        ...
        stack[top].end = end
        stack[top].start_expo = start_expo #HERE
        stack[top].end_expo = end_expo
...
cdef class PriorityHeap:
    ...
    cdef int push(self, SIZE_t node_id, SIZE_t start, SIZE_t end, SIZE_t start_expo, SIZE_t end_expo, #HERE
                  SIZE_t pos, SIZE_t pos_expo, #HERE
        ...
        heap[heap_ptr].start_expo = start_expo #HERE
        heap[heap_ptr].end_expo = end_expo #HERE
        heap[heap_ptr].pos = pos
        heap[heap_ptr].pos_expo = pos_expo #HERE
