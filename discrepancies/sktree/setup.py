...
DISTNAME = "sktree"
DESCRIPTION = "A thibault set of python modules for machine learning and data mining"
...
import sktree  # noqa
import sktree._min_dependencies as min_deps  # noqa
from sktree.externals._packaging.version import parse as parse_version  # noqa
...
class CleanCommand(Clean):
    ...
    def run(self):
        ...
        if os.path.exists("build"):
            shutil.rmtree("build")
        for dirpath, dirnames, filenames in os.walk("sktree"):
    ...
    class build_ext_subclass(build_ext):
        def finalize_options(self):
            ...
            if self.parallel is None:
                ...
                parallel = os.environ.get("SKTREE_BUILD_PARALLEL")
                if parallel:
        ...
        def build_extensions(self):
            from sktree._build_utils.openmp_helpers import get_openmp_flag
...
def configuration(parent_package="", top_path=None):
    ...
    from sktree._build_utils import _check_cython_version
