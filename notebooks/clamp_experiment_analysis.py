...
def get_all_expe():
    ...
    OUTPUT_DIR = pathlib.Path(str(pathlib.Path('../..').resolve())+'/results_clamps/')
    ...
    for repl in repls:
        ...
        for i,r in df_plan.iterrows():
            ...
            try:
                ...
                competitors = ['precision_all', 'precision_without_disctrain', 'n_generated']
        ...
        #df = df.melt(id_vars=['pool','dataset','k_init','k_refinement','max_epochs','n_sampling', 'n_generated'], 
            #var_name="competitor", 
